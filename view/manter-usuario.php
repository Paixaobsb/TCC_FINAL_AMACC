            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><a id="cor-doacoes" href="relatorio.php" class="btn btn-warning">Doações</a></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <div class="modal" id="excluiremail">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- Modal body -->
                        <div class="modal-body">
                            <label for"nome">Deseja excluir "E-mail"</label>
            ...
            <div class="modal" id="excluirphone">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- Modal body -->
                        <div class="modal-body">
                            <label for"nome">Deseja excluir "Telefone"</label>
